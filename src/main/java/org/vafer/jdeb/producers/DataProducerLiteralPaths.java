...
public class DataProducerLiteralPaths extends AbstractDataProducer implements DataProducer {

  private String[] literalPaths;

  public DataProducerLiteralPaths(String[] pLiteralPaths, String[] pIncludes, String[] pExcludes, Mapper[] pMapper) {
